...
export default function DictionaryComponent({ dictionary }: Props) {
  ...
  const chapterCount = dictionary.chapterCount
      ...
      <DialogTrigger asChild>
        ...
        >
          <div className="relative ml-1 mt-2 flex h-full w-full flex-col items-start justify-start">
            ...
            <p className={`mb-0.5 font-bold  ${isSelected ? 'text-white' : 'text-gray-600 dark:text-gray-200'}`}>{dictionary.length} {dictionary.mode === 'sgd' ? '短句' : '训练项'}</p>
